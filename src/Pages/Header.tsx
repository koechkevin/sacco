...
import { faPowerOff, faStream } from '@fortawesome/pro-regular-svg-icons';
...
const Header: FC<any> = () => {
  ...
  const { dispatch, state: { drawerOpen }} = useContext(AppContext);
  return <div className={styles.header}>
    <div>
      {isMobile && !drawerOpen && <Icon onClick={() => dispatch && dispatch({ drawerOpen: true})} hover icon={faStream} />}
    </div>
    <div>
